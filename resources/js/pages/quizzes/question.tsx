...
export default function Question({
  ...
  return (
    <Card className="mb-6">
      <CardHeader className="flex flex-row items-center justify-between border-b bg-gray-50 px-4 py-3">
        <div className="flex items-center gap-2">
          <Select value={questionType} onValueChange={(value: any) => setQuestionType(value)}>
            <SelectTrigger className="w-[160px]">
              <div className="flex items-center">
                {questionType === 'multiple_choice' && <span className="mr-2">⊙</span>}
                {questionType === 'true_or_false' && <span className="mr-2">⊙</span>}
                {questionType === 'short_answer' && <span className="mr-2">✎</span>}
